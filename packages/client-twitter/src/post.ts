...
# Task: Generate a unique post in the voice and style and perspective of {{agentName}} @{{twitterUserName}}.
...
- No emojis
- No hashtags
- Use \\n\\n (double spaces) between statements if multiple
...
export class TwitterPostClient {
    ...
    async generateNewTweet() {
        ...
        try {
            ...
            console.log("Generate tweet context");
            console.log(context);
